...
class ImagePickerLayout: UICollectionViewLayout {
  class Attributes: UICollectionViewLayoutAttributes {
    ...
    override func copy() -> Any {
      let copy = super.copy() as! ImagePickerLayout.Attributes
    ...
    var duplicate: ImagePickerLayout.Attributes {
      return copy() as! ImagePickerLayout.Attributes
    }
